...
class SignUp extends React.Component {
   ...
   async validdateAndCreateUser() {
      ...
      const restuarantInput = document.getElementById("restuarant-input").value;
      ...
      if (
         ...
         const user = {
            ...
            createdAt: Date.now(),
            restuarantName: restuarantInput,
            address: addressInput,
            phoneNumber: phoneNumberInput,
         };
         console.log("Created Current User for Post: ", user);
         axios
            .get(
               "https://raw.githubusercontent.com/marshhpc/tonights-special/master/src/moc-data/user.json"
            )
            .then((res) => {
